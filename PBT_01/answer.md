...
#### Câu B4
1. Trong screenshot thegioididong.com dưới ta thấy:
...
![Network Practice](./screenshots/B4.1(thegioididong-the).png)

2. Một `<table>` trong trang dưới:
...
![Network Practice](./screenshots/B4.2(thegioididong-table).png)

3. Một `<form>` trong trang dưới:
...
![Network Practice](./screenshots/B4.3(thegioididong-form).png)
